          ...
          <div class="section-header">
            <h1><i class="fas fa-id-card mr-2" style="font-size: 20pt;"></i>Pendataan Data E-Ktp Kelurahan 4</h1>
          </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                  <table class="table" id="dataTable">
                    ...
                    <tbody>
                      <?php $dataEktp = mysqli_query($con, "SELECT * FROM masyarakat WHERE kelurahan = 'Kelurahan 4' ORDER BY nama"); ?>
                      <?php $no=1; ?>
